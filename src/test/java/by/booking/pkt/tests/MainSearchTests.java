...
//На вход подать:
  ...
  public void testSearchAccomadationsNegative(String city) {
    System.out.println("Поиск несуществующего города");
    app.driver.findElement(By.id("ss")).click();
    app.driver.findElement(By.id("ss")).clear();
    app.driver.findElement(By.id("ss")).sendKeys(city);
    app.driver.findElement(By.cssSelector("button[data-sb-id=main]")).click();
    Assertion assertion = new Assertion();
    assertion.assertTrue(app.driver.findElement(By.cssSelector("[class^=sb-searchbox__error]")).isDisplayed(), "Unresolved accomodation found!");
  }
  ...
  public void testSearchAccomadations(String city, int crooms, int cadults, int cchildren) {
    app.driver.findElement(By.id("ss")).click();
    app.driver.findElement(By.id("ss")).clear();
    app.driver.findElement(By.id("ss")).sendKeys(city);
    app.driver.findElement(By.cssSelector("button[data-sb-id=main]")).click();
