...
public class SortResultsTests extends TBase {
  @Test(enabled = true, groups = {"positive", "smoke", "sort"},
          dataProviderClass = FileDataProvider.class, dataProvider = "searchDataFromXML")
  @DataSourceFileAnnotation("src\\test\\resources\\search-positive.xml")
  public void testSortByDistance(SearchData searchData) throws InterruptedException {
...
//    }
  ...
  @Test(enabled = true, groups = {"positive", "smoke", "sort"},
          dataProviderClass = FileDataProvider.class, dataProvider = "searchDataFromXML")
  @DataSourceFileAnnotation("src\\test\\resources\\search-positive.xml")
  public void testSortByPrice(SearchData searchData) throws InterruptedException {
//    app.searchPage().searchFor(searchData);
