...
public class FilterBoxHelper extends HelperBase {
   private static final String REGEX_NIGHTS = "\\d+";
   ...
   private WebElement nightsCountField;
   ...
   public boolean selectStars(int stars) {
      ...
      return starsElement.findElement(By.cssSelector("input")).isSelected();
   }
   ...
   public int getMaxTotalPrice() {
      return getNightsCount() * maxBudget;
   }

   public int getMinTotalPrice() {
      return getNightsCount() * minBudget;
   }

   private int getNightsCount() {
      return Integer.parseInt(textByPatternWithout(REGEX_NIGHTS, "\\s", nightsCountField.getText()));
   }
}
